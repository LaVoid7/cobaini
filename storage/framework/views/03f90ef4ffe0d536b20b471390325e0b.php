<?php $__env->startSection('content'); ?>
    <div class="container-sm mt-5">
        <form action="<?php echo e(route('procurement.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="mb-3 text-center">
                <img class="img-fluid rouned-circle"
                    src="<?php echo e(Vite::asset('resources/images/telpro.png')); ?>"alt="image" style="width: 50%;">
                </i>
                <h2><?php echo e('Input Data Procurement'); ?></h2>
            </div>
...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="regional" id="regional" value="<?php echo e(old('regional')); ?>"
...
unset($__errorArgs, $__bag); ?>" type="text" name="juspeng"
                                id="juspeng" value="<?php echo e(old('juspeng')); ?>" placeholder="Juspeng">
...
unset($__errorArgs, $__bag); ?>" type="date" name="tgl_terima_juspeng"
                                id="tgl_terima_juspeng" value="<?php echo e(old('tgl_terima_juspeng')); ?>" placeholder="Tanggal Terima Juspeng">
...
unset($__errorArgs, $__bag); ?>" type="text" name="customer"
                                    id="customer" value="<?php echo e(old('customer')); ?>" placeholder="Customer">
...
unset($__errorArgs, $__bag); ?>" type="text" name="anggaran"
                                    id="anggaran" value="<?php echo e(old('anggaran')); ?>" placeholder="Anggaran">
...
unset($__errorArgs, $__bag); ?>" type="text" name="margin_presentase"
                                id="margin_presentase" value="<?php echo e(old('margin_presentase')); ?>" placeholder="Margin Presentase">
...
unset($__errorArgs, $__bag); ?>" type="text" name="margin_nominal"
                                    id="margin_nominal" value="<?php echo e(old('margin_nominal')); ?>" placeholder="Margin Nominal">
...
unset($__errorArgs, $__bag); ?>" type="text" name="nama_PIC"
                                id="nama_PIC" value="<?php echo e(old('nama_PIC')); ?>" placeholder="Nama PIC">
...
unset($__errorArgs, $__bag); ?>" type="text" name="metode_pengadaan"
                                id="metode_pengadaan" value="<?php echo e(old('metode_pengadaan')); ?>" placeholder="Metode Pengadaan">
...
unset($__errorArgs, $__bag); ?>" type="text" name="mitra_peserta"
                                id="mitra_peserta" value="<?php echo e(old('mitra_peserta')); ?>" placeholder="Mitra Peserta">
...
unset($__errorArgs, $__bag); ?>" type="text" name="penetapan_mitra"
                                id="penetapan_mitra" value="<?php echo e(old('penetapan_mitra')); ?>" placeholder="Penetapan Mitra">
...
unset($__errorArgs, $__bag); ?>" type="text" name="bidang_pekerjaan"
                                id="bidang_pekerjaan" value="<?php echo e(old('bidang_pekerjaan')); ?>" placeholder="Bidang Pekerjaan">
...
unset($__errorArgs, $__bag); ?>" type="text" name="kontrak"
                                id="kontrak" value="<?php echo e(old('kontrak')); ?>" placeholder="Kontrak ">
...
unset($__errorArgs, $__bag); ?>" type="date" name="tgl_penetapan"
                                id="tgl_penetapan" value="<?php echo e(old('tgl_penetapan')); ?>" placeholder="Tanggal Penetapan ">
...
unset($__errorArgs, $__bag); ?>" type="date" name="tgl_kontrak"
                                id="tgl_kontrak" value="<?php echo e(old('tgl_kontrak')); ?>" placeholder="Tanggal Kontrak ">
...
unset($__errorArgs, $__bag); ?>" type="text" name="kesepakatan"
                                    id="kesepakatan" value="<?php echo e(old('kesepakatan')); ?>" placeholder="Kesepakatan">
...
unset($__errorArgs, $__bag); ?>" type="text" name="margin_presentase_regional"
                                id="margin_presentase_regional" value="<?php echo e(old('margin_presentase_regional')); ?>" placeholder="Margin Presentase Regional ">
...
unset($__errorArgs, $__bag); ?>" type="text" name="margin_nominal_regional"
                                    id="margin_nominal_regional" value="<?php echo e(old('margin_nominal_regional')); ?>" placeholder="Margin Nominal Regional">
...
unset($__errorArgs, $__bag); ?>" type="date" name="tgl_mulai_pekerjaan"
                                id="tgl_mulai_pekerjaan" value="<?php echo e(old('tgl_mulai_pekerjaan')); ?>" placeholder="Tanggal Mulai Pekerjaan">
...
unset($__errorArgs, $__bag); ?>" type="date" name="tgl_selesai_pekerjaan"
                                id="tgl_selesai_pekerjaan" value="<?php echo e(old('tgl_selesai_pekerjaan')); ?>" placeholder="Tanggal Selesai Pekerjaan">
...
unset($__errorArgs, $__bag); ?>" type="text" name="keterangan"
                                id="keterangan" value="<?php echo e(old('keterangan')); ?>" placeholder="Keterangan"></textarea>
...
unset($__errorArgs, $__bag); ?>" type="date" name="tgl_tagihan_mitra"
                                id="tgl_tagihan_mitra" value="<?php echo e(old('tgl_tagihan_mitra')); ?>" placeholder="Tanggal Tagihan Mitra">
...
unset($__errorArgs, $__bag); ?>" type="date" name="tgl_kirim_tagihan_mitra"
                                id="tgl_kirim_tagihan_mitra" value="<?php echo e(old('tgl_kirim_tagihan_mitra')); ?>" placeholder="Tanggal Kirim Tagihan Mitra">
...
unset($__errorArgs, $__bag); ?>" type="date" name="tgl_bayar_tagihan_mitra"
                                id="tgl_bayar_tagihan_mitra" value="<?php echo e(old('tgl_bayar_tagihan_mitra')); ?>" placeholder="Tanggal Bayar Tagihan Mitra">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\LaVoid\KULIAH\KP\KerjaPraktik\resources\views/procurement/create.blade.php ENDPATH**/ ?>